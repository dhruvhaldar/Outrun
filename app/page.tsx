...
function Dashboard({ result }: { result: ApiResult }) {
  ...
  return <section className="dashboard">
    ...
    <div className="panel"><h2>Growth of $1</h2><ResponsiveContainer width="100%" height={360}><LineChart data={result.daily_curves}><CartesianGrid stroke="#000" strokeWidth={1} /><XAxis dataKey="date" minTickGap={40} stroke="#000" tick={{ fill: "#000", fontWeight: "bold" }} /><YAxis domain={["auto", "auto"]} stroke="#000" tick={{ fill: "#000", fontWeight: "bold" }} /><Tooltip formatter={(value) => Number(value).toFixed(3)} contentStyle={{ borderRadius: 0, border: "4px solid #000", boxShadow: "4px 4px 0 #000", fontWeight: "bold", textTransform: "uppercase" }} /><Line type="linear" dataKey="portfolio" stroke="#e4002b" strokeWidth={4} dot={false} /><Line type="linear" dataKey="voo" stroke="#004b87" strokeWidth={4} dot={false} /></LineChart></ResponsiveContainer></div>
